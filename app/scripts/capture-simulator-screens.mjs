...
const captures = [
  ...
  { scenario: 'settings', file: path.join(productOutputDir, '02-settings-home.png') },
  { scenario: 'flow-intro', file: path.join(productOutputDir, '03-flow-step-1-intro.png') },
  { scenario: 'flow-starter-set', file: path.join(productOutputDir, '04-flow-step-2-starter-set.png') },
  {
    scenario: 'flow-request-review',
    file: path.join(productOutputDir, '05-flow-step-3-request-review.png'),
  },
  { scenario: 'flow-gmail-send', file: path.join(productOutputDir, '06-flow-step-4-gmail-send.png') },
  {
    scenario: 'flow-final-review',
    file: path.join(productOutputDir, '07-flow-step-5-final-review.png'),
  },
  { scenario: 'flow-beat-sent', file: path.join(productOutputDir, '08-flow-beat-sent.png') },
  { scenario: 'flow-beat-subscribe', file: path.join(productOutputDir, '09-flow-beat-subscribe.png') },
  { scenario: 'home-unsubscribed', file: path.join(productOutputDir, '10-home-unsubscribed.png') },
  { scenario: 'home-subscribed', file: path.join(productOutputDir, '11-home-subscribed.png') },
  { scenario: 'settings-subscription', file: path.join(productOutputDir, '12-settings-subscription.png') },
  { scenario: 'settings-profile', file: path.join(productOutputDir, '13-settings-profile.png') },
  { scenario: 'settings-privacy', file: path.join(productOutputDir, '14-settings-privacy.png') },
  { scenario: 'settings-diagnostics', file: path.join(productOutputDir, '15-settings-diagnostics.png') },
  { scenario: 'settings-support', file: path.join(productOutputDir, '16-settings-support.png') },
