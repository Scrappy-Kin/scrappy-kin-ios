...
Build, verify, install, and launch the QA StoreKit lane on a connected iPhone via QADevice.
...
Build, verify, install, and launch the QA StoreKit lane on a simulator.
