...
import DisclosureSheetRow from '../../ui/patterns/DisclosureSheetRow'
  ...
  return (
    <section className="app-section-shell app-stack--loose flow-onboarding-intro">
      ...
      <DisclosureSheetRow
        ...
        sheetTitle="What's a data broker?"
        accessibilityLabel="Learn what a data broker is"
        sheetBody={
      ...
      <DisclosureSheetRow
        ...
        sheetTitle="How does Scrappy Kin pick brokers?"
        accessibilityLabel="Learn how Scrappy Kin picks brokers"
        sheetBody={
          <div className="app-stack">
            <AppText intent="body">
      ...
      <DisclosureSheetRow
        ...
        sheetTitle="What can Scrappy Kin see?"
        accessibilityLabel="Learn what Scrappy Kin can see"
        sheetBody={
          <div className="app-stack">
            <AppText intent="body">
