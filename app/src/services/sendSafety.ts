...
export const SEND_SAFETY_NOTICES: Partial<Record<SendSafetyMode, {
  ...
  qa_blocked: {
    ...
    body: [
      'This QA build only sends when the local profile email is scrappykin365@gmail.com.',
...
export const QA_DEVICE_BLOCKED_SEND_MESSAGE =
  'This QA build only sends when the local profile email is scrappykin365@gmail.com. No emails were sent.'
